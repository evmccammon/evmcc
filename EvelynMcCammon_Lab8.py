...
# Your unit tests
assert remove_duplicates_set({"dog", "cat", "hamster", "dog", "cat"}) == {"dog", "cat", "hamster"}
assert remove_duplicates_set({"apple", "banana", "apple", "cherry"}) == {"apple", "banana", "cherry"}
...
#print (students_id_occurrences(['002', '003', '001', '012', '003', '001']))
# Your unit tests
...
assert students_id_occurrences(['002', '003', '001', '012', '003', '001', '002']) == {'002':2, '003': 2, '001': 2, '012': 1}
