...
num_steps = 10
alex.speed(0)  # 1 sets the drawing speed as the slowest.
...
alex.clear()  # Clear the previous drawing on the screen.
alex.num_sides = 6 
alex.exterior_angle = 360 / alex.num_sides
side_length = 100
for _ in range(alex.num_sides):
    alex.forward(side_length)
    alex.left(alex.exterior_angle)
alex.shape("blank")
...
num_circles = 7
rainbow_colors = ["#582F6B", "#19477C", "#2A8F9E", "#2CBE64", "#F1D747","#FA8901", "#ED3847"]
radius = 30
radius_increase = 10
alex.clear()  # Clear the previous drawing on the screen.
alex.speed(5)
...
alex.clear()
num_circles = 7
background_color = "#acd7e6"
radius = 180
radius_increase = 25
alex.speed(5)
alex.pensize(25)
alex.left(90)
drawing_screen.bgcolor(background_color)
for rainbow_color in rainbow_colors:
    alex.up()
    alex.goto(radius,0)
    alex.down()
